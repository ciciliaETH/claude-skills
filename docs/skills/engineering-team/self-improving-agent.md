...
<span class="meta-badge">:material-github: <a href="https://github.com/ciciliaETH/claude-skills/tree/main/engineering-team/self-improving-agent/skills/self-improving-agent/SKILL.md">Source</a></span>
</div>
...
- [playwright-pro](https://github.com/ciciliaETH/claude-skills/tree/main/engineering-team/self-improving-agent/skills/playwright-pro) — sister plugin in this repo
