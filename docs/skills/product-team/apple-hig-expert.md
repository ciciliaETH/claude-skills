...
<span class="meta-badge">:material-github: <a href="https://github.com/ciciliaETH/claude-skills/tree/main/product-team/apple-hig-expert/skills/apple-hig-expert/SKILL.md">Source</a></span>
</div>
...
### Mode 2: HIG Audit 
When reviewing mockups or code. Use the [templates/hig-audit-template.md](https://github.com/ciciliaETH/claude-skills/tree/main/product-team/apple-hig-expert/skills/apple-hig-expert/templates/hig-audit-template.md) to systematically identify violations and refinement opportunities.
...
See [references/platform-specifics.md](https://github.com/ciciliaETH/claude-skills/tree/main/product-team/apple-hig-expert/skills/apple-hig-expert/references/platform-specifics.md) for details.

### Phase 2: Visual Styling
Apply typography (San Francisco family) and semantic colors. 
See [references/visual-design.md](https://github.com/ciciliaETH/claude-skills/tree/main/product-team/apple-hig-expert/skills/apple-hig-expert/references/visual-design.md).
