...
<span class="meta-badge">:material-github: <a href="https://github.com/ciciliaETH/claude-skills/tree/main/marketing-skill/skills/free-tool-strategy/SKILL.md">Source</a></span>
</div>
...
See [references/tool-types-guide.md](https://github.com/ciciliaETH/claude-skills/tree/main/marketing-skill/skills/free-tool-strategy/references/tool-types-guide.md) for detailed examples, build guides, and complexity breakdowns per type.
