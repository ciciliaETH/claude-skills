...
<span class="meta-badge">:material-github: <a href="https://github.com/ciciliaETH/claude-skills/tree/main/marketing-skill/skills/content-humanizer/SKILL.md">Source</a></span>
</div>
...
See [references/ai-tells-checklist.md](https://github.com/ciciliaETH/claude-skills/tree/main/marketing-skill/skills/content-humanizer/references/ai-tells-checklist.md) for the comprehensive detection list.
...
See [references/voice-techniques.md](https://github.com/ciciliaETH/claude-skills/tree/main/marketing-skill/skills/content-humanizer/references/voice-techniques.md) for specific techniques for each voice type.
